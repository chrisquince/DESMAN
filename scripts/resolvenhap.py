...
def main(argv):
    ...
    if newNG > 0:
        ...
        gammaR = gamma.iloc[:,selected_strains]
        ...
        gammaR2 = gamma2.iloc[:,selected_strains]
        ...
        tauR2 = tau2.iloc[:,tau_select_idx]
        ...
        if os.path.isfile(tau_collated_file):
            ...
            tauCR = tauC.iloc[:,tau_select_idx]
            ...
            tauCR2 = tauC2.iloc[:,tau_select_idx]
